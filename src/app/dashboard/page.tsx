    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="container mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Overview of the latest activities and stats.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow-md rounded-lg p-6 hover:shadow-lg transition-shadow duration-300">
            <h2 className="text-xl font-semibold text-gray-700">Total Visitors</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-6">
            <h2 className="text-xl font-semibold text-gray-700 mb-4">Categories Distribution</h2>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={categoryData}
