        ...
        <nav className="hidden md:flex items-center space-x-4">
          ...
          <Popover className="relative">
            ...
            <Popover.Panel className="absolute left-0 z-10 mt-2 w-56 rounded-lg bg-orange-500 text-white shadow-lg">
              <div className="py-2">
                {[
                  { href: "/dashboard/table/currently-open-places", icon: ClockIcon, text: "เปิดในขณะนี้" },
                  { href: "/dashboard/table/season-real-time", icon: SunIcon, text: "ฤดูกาลนี้" },
                  { href: "/dashboard/table/top-rated-tourist-entities", icon: StarIcon, text: "ติดอันดับ" },
                  { href: "/place", icon: BuildingOfficeIcon, text: "สถานที่ทั้งหมด" },
                  { href: "/dashboard/table/tourist-attractions", icon: MapIcon, text: "สถานที่ท่องเที่ยว" },
                  { href: "/dashboard/table/accommodations", icon: BuildingStorefrontIcon, text: "ที่พัก" },
                  { href: "/dashboard/table/restaurants", icon: GiftIcon, text: "ร้านอาหาร" },
                  { href: "/dashboard/table/souvenir-shops", icon: ShoppingBagIcon, text: "ร้านค้าของฝาก" },
                ].map((item, index) => (
                  <a
                    key={index}
                    href={item.href}
          ...
          <Popover className="relative">
            ...
            <Popover.Panel className="absolute left-0 z-10 mt-2 w-56 rounded-lg bg-orange-500 text-white shadow-lg">
              <div className="py-2">
                {[
                  { href: "/dashboard/table/categories", icon: ClockIcon, text: "ตารางหมวดหมู่สถานที่" },
                  { href: "/dashboard/table/districts", icon: SunIcon, text: "ตารางอำเภอ" },
                  { href: "/dashboard/table/operating-hours", icon: CubeIcon, text: "ตารางเวลาทำการสถานที่" },
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-20 w-full max-w-sm overflow-y-auto bg-orange-500 text-white px-6 py-6 sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="mt-6 space-y-4 ">
            ...
            <button
              type="button"
              onClick={handleLogout}
              className={`flex items-center justify-center w-full text-lg text-white bg-transparent border-2 border-white hover:bg-white hover:text-orange-500 transition duration-300 ease-in-out transform hover:scale-105 rounded-full px-4 py-2 shadow-md ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
