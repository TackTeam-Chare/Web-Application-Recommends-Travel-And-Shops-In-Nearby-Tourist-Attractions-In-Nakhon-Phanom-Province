...
import { GoogleMap, Marker, InfoWindow, DirectionsRenderer, Circle } from '@react-google-maps/api';
...
const MapSearch: React.FC<MapSearchProps> = ({
  ...
  useEffect(() => {
    if (isLoaded && userLocation && (searchResults.length > 0 || nearbyPlaces.length > 0)) {
      ...
      {selectedPlace && (
        ...
        >
          <div className="flex items-center max-w-md p-4 bg-white rounded-lg shadow-md text-gray-800">
            <NextImage
              src={selectedPlace.images && selectedPlace.images[0]?.image_url ? selectedPlace.images[0].image_url : "/default-image.jpg"}
            ...
            <div className="ml-4 flex-1">
              ...
              <p className="text-orange-500 font-bold flex items-center">{selectedPlace.category_name}</p>
              <p className="text-orange-500 font-bold flex items-center">{selectedPlace.district_name}</p>
              <p className="text-orange-500 font-bold flex items-center"> {selectedPlace.season_name}</p>
              <p className="text-orange-500 font-bold flex items-center"> {selectedPlace.openingHours}</p>
              <p className="text-orange-500 font-bold flex items-center">{selectedPlace.rating} ⭐</p>
